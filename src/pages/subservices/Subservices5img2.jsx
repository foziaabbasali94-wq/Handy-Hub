...
import Basic2 from "../../assets/basicmakeover2.jpg";

function Subservices5img2() {
  const navigate = useNavigate();

  const handleEnquire = () => {
    navigate("/subservices/5/subdetailservice/2"); // update route if needed
  };
...
export default Subservices5img2;
